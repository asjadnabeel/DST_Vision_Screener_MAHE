...
public class Mrda_StimuliTabbedResults extends AppCompatActivity {
...
//        }
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            Map<Integer, Double> mapz = ((Mrda_StimuliTabbedResults)getActivity()).getPercentagesMap();
            Map<Integer, trialData> resultsUserHistory = ((Mrda_StimuliTabbedResults)getActivity()).getUserHistory();
            averageThreshold = ((Mrda_StimuliTabbedResults)getActivity()).calculateThreashold();
